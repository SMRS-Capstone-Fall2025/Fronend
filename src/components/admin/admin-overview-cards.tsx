...
import type { AdminOverviewDto } from "@/services/admin-stats";
...
export function AdminOverviewCards({
  ...
  const cards = [
    {
      title: "Tổng dự án",
      value: data.totalProjects.toLocaleString("vi-VN"),
      icon: FolderKanban,
    ...
    },
    {
      ...
      value: data.activeProjects.toLocaleString("vi-VN"),
      icon: TrendingUp,
      growth: data.activeProjectsGrowth,
