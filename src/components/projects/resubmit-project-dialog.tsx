...
import type { ResubmitProjectRequest } from "@/services/types/project";
import {
...
interface ResubmitProjectDialogProps {
  ...
  readonly onSubmit: (data: ResubmitProjectRequest) => Promise<void>;
  readonly isSubmitting?: boolean;
}

export function ResubmitProjectDialog({
  open,
  onOpenChange,
  projectName,
  projectDescription,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Không thể nộp lại dự án",
        description: getErrorMessage(error, "Không thể nộp lại dự án"),
      });
    }
  };
            ...
            <DialogHeader className="space-y-4 text-left">
              <div className="space-y-2">
                ...
                <DialogDescription className="max-w-2xl text-sm leading-relaxed text-slate-600">
                  Cập nhật thông tin, chỉnh sửa mô tả và đính kèm tài liệu mới
                  để nộp lại dự án sau khi đã được yêu cầu sửa đổi.
                </DialogDescription>
              </div>
            </DialogHeader>
          </div>
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-dashed border-primary/30 bg-white/85 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] backdrop-blur">
                        ...
                        <label
                          htmlFor="resubmit-project-documents"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-dashed border-primary/30 bg-white/85 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] backdrop-blur">
                        ...
                        <label
                          htmlFor="resubmit-project-images"
                          className="relative flex cursor-pointer flex-col items-center gap-2 px-5 py-7 text-center text-sm text-muted-foreground transition hover:bg-primary/5"
                          onDragOver={(event) => event.preventDefault()}
                          onDrop={(event) => {
                            event.preventDefault();
