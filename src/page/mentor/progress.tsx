...
import { AlertCircle, Flag, PlusCircle, ShieldAlertIcon } from "lucide-react";
import {
  ProjectSelect,
                      ...
                      <div className="flex flex-col items-center">
                        <span
                          className={cn(
                            ...
                            isFinalMilestone && "bg-orange-500"
                          )}
                        />
                        {idx < sortedMilestones.length - 1 ? (
                          <div className="mt-1 h-full w-[2px] bg-border/60" />
                        ) : null}
                      </div>
                      <div
                        role="button"
                        ...
                        onKeyDown={(event) => {
                          if (event.key === "Enter" || event.key === " ") {
                            event.preventDefault();
                            handleOpenMilestone(m);
                          }
                        }}
                        className={cn(
                          "flex-1 rounded-lg border border-border/60 bg-background/60 p-4 text-left transition hover:border-primary/50 hover:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-primary",
                          detailOpen && selectedMilestone?.id === m.id
                            ? "border-primary"
                            : undefined,
                          isFinalMilestone &&
                      ...
                      >
                        ...
                        {(() => {
                          ...
                          const progressPercent =
                            derivedProgress ?? m.progressPercent;
                          return (
                        ...
                        {isFinalMilestone ? (
                          <div className="mt-3 inline-flex items-center gap-1 rounded-full border border-primary/40 bg-primary/5 px-2 py-1 text-[11px] font-semibold uppercase tracking-wide text-primary">
